...
class MPNNGNN(nn.Module):
    ...
    def __init__(self, node_in_feats, edge_in_feats, node_out_feats=128,
                 edge_hidden_feats=128, num_step_message_passing=1):
    ...
    def reset_parameters(self):
        ...
        for layer in self.gnn_layer.edge_nn:
            print("sinstance(layer, nn.Linear):",isinstance(layer, nn.Linear))
    ...
    def forward(self, g, node_feats, edge_feats):
        ...
        for _ in range(self.num_step_message_passing):
            ...
            hidden_feats = hidden_feats[:,:g.num_dst_nodes(),:]
            node_feats, hidden_feats = self.gru(node_feats.unsqueeze(0), hidden_feats)
            node_feats = node_feats.squeeze(0)
            node_feats = F.pad(input=node_feats, pad=(0,0,(g.num_src_nodes()- g.num_dst_nodes()),0), mode='constant', value=1)
