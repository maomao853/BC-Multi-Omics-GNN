#!/bin/bash
  ...
  do
    ...
    do
      ...
      python ./group-lasso/prepare_input_DepMap_cMap.py --ont ./hier.csv --y $y --c $c --out ./HGNN_depmap
  ...
  do
    ...
    do
      ...
      python ./group-lasso/prepare_input_DepMap_cMap.py --ont ../hier.csv --y $y --c $c --out ./HGNN_cmap
